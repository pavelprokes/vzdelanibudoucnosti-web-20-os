...
export const RegisterFormForOnlineAdult = ({ course, lecturer, capacityStatus }: RegistrationFormProps) => {
  ...
  return (
    <RegisterFormWrapper>
      <Formik<RegisterStudentCourse>
        ...
        {({ values, handleSubmit, handleChange, handleBlur, touched, errors, isValidating, isSubmitting, setFieldValue }) => (
          <>
            <Form>
              <div>
