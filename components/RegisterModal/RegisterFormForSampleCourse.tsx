...
import { yearOfStudies } from "./enums"
...
export const RegisterFormForSampleCourse = ({ course, lecturer, capacityStatus }: RegistrationFormProps) => {
          ...
          <>
            <Form>
              <div>
                ...
                <Typography.Title level={3}>Údaje o uchazeči na ukázkovou lekci</Typography.Title>
