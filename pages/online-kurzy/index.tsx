...
const Krouzky = ({ courses }: Props) => {
  const title = `Online kurzy pro dospělé`
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`${webUrl}/online-kurzy`}
        openGraph={{
          url: `${webUrl}/online-kurzy`,
          title: `${title} | ${secondTitle}`,
          description,
          images: [
            {
...
export const getStaticProps: GetStaticProps = async (): Promise<GetStaticPropsResult<Props>> => {
  const coursesRes = await getCourseList({ type: CourseType.online, ageGroup: CourseAgeGroup.adult })
