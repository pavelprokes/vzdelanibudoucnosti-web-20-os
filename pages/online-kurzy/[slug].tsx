...
const OnlineKurzySlug = (props: Props) => {
...
export const getStaticPaths: GetStaticPaths = async (): Promise<GetStaticPathsResult> =>
  getStaticCoursesPageSlugPaths({ ageGroup: CourseAgeGroup.adult, type: CourseType.online })

export const getStaticProps: GetStaticProps = async ({ params }): Promise<GetStaticPropsResult<Props>> =>
  getStaticCoursesPageSlugProps(params, { ageGroup: CourseAgeGroup.adult, type: CourseType.online })

export default OnlineKurzySlug
