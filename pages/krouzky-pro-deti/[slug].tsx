...
const KrouzkyProDetiSlug = (props: Props) => {
...
export const getStaticPaths: GetStaticPaths = async (): Promise<GetStaticPathsResult> => getStaticCoursesPageSlugPaths({ ageGroup: CourseAgeGroup.children })

export const getStaticProps: GetStaticProps = async ({ params }): Promise<GetStaticPropsResult<Props>> =>
  getStaticCoursesPageSlugProps(params, { ageGroup: CourseAgeGroup.children })

export default KrouzkyProDetiSlug
